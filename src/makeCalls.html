...
<head>
    <meta charset="utf-8"/>
    <title>MCS Computer Vision API: How-to Make Calls </title>
      <link rel="stylesheet" type="text/css" href="/css/main.css">
</head> 
	<form action="https://deirdreemoran.github.io/howToGuide.html" method="get">
...
<iframe width="60%" height="300" src="//jsfiddle.net/morand/r5s1594u/1/embedded/" allowfullscreen="allowfullscreen" frameborder="0"></iframe>			
		...
		<form action="https://deirdreemoran.github.io/index.html" method="get">
<button class="button" type="submit" >Getting Started</button>
				 </form>
	<form action="" method="get">
		<button class="button" type="submit" >Calling the API</button>
	</form>
	<form action="https://deirdreemoran.github.io/displayResponse.html" method="get">
  <button class="button" type="submit" >Receiving Data</button>
</form>
